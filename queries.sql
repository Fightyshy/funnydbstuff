...
LEFT JOIN games AS g ON teams.team_id = g.opponent_id
WHERE (games.round='Eighth-Final' AND games.year=2014) OR (g.round='Eighth-Final' AND g.year=2014) ORDER BY name")
